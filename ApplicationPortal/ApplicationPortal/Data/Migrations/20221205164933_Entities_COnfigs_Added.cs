        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AntennaGainUnit = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AntennaGains", x => x.AntennaGainId);
                    table.ForeignKey(
                        name: "FK_AntennaGains_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Frequencies_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AntennaGains_ProductId",
                table: "AntennaGains",
                column: "ProductId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Frequencies_ProductId",
                table: "Frequencies",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_Name_Model",
                table: "Products",
